...
//	FALTA:
	...
	arFunctPerz: new Array(),
	getNumPerz: function()
		{ return this.arFunctPerz.length; },
};
	...
	this.itIs=function(itIs)
	{
		switch(itIs)
		{
			...
			case 'html':
				...
				break;
			default:
				//	Averigua si es personalizado
				if(itIs.split('__').length==2)
				{ this.setType('personalize'); this.setSubType(itIs); }
				break;
		}
		return this;
	};
		...
		for(var contObject=0;contObject<numObject;contObject++)
		{
			...
			switch(object.getType())
			{
				...
				case 'html':
					...
					break;
				case 'personalize':
					for(var contFunctPerz=0;contFunctPerz<ei_static.arFunctPerz.length;contFunctPerz++)
					{
						var object_=ei_static.arFunctPerz[contFunctPerz](object.getSubType());
						object_=object_.replace('[[width]]',object.getWidth());
						object_=object_.replace('[[height]]',object.getHeight());
						object.object.innerHTML=object_;
					}
					break;
			}
			//	Crea un rectangulo
