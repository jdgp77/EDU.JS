...
_EduIntBasic = {
    ...
    _random: function(value1,value2) {
        ...
        return parseInt(Math.random(lugaresEnX)*(value2)+value1);
    },
    //  1,2,3,4,5 <= _EduInt._Basic.randomInt(1,5)
    //  1,2,3,4 <= _EduInt._Basic.randomInt(4)
    randomInt: function(value1,value2){ this._randomInt(value1,value2); },
    _randomInt: function(value1,value2) {
        return parseInt(Math.random()*(value2)+value1);
    },
    ...
    createPersonalizedType: function(Thing) { _EduInt._Thing._Type.createPersonalizedFunction(Thing); },
    createPersonalizedType: function(numBoard) { _EduInt._Board._qstnIssetBoard(numBoard); },
...
_EduInt = {
    ...
    //  ALERT - Comentar
            ...
            this._startAnimation = function()
            {
                ...
                {
                    var numFunctionAnimated=this._atopbar-thirdrNumOfFunctnToStatInAnimation[countFunctAnimated];
    ...
    _Thing: {
        ...
        _arCustoms: [],
        setCustom: function(name,myFunction) { _EduInt._Thing._setCustom(name,myFunction); },
            ...
            this._createThingType = function()
            {
                ...
                switch(this._Type)
                {
                    ...
                    case 'text':
                        ...
                        _EduInt._Basic.addThingTextFunctions(this);
...
//  Que es adition 1?
    ...
    //Falta comentarlo en documentación
            ...
            this.getCustom = function(name) { this._getCustom(name); };
            this._getCustom = function(name)
            {
                this._myFunction_ = _EduInt.Thing._arCustoms[name];
                this._myFunction_();
            };
        },
        ...
        //  Cambiarle el nombre por setBackgroundImage
                ...
                Thing._setBackgroundImage = function(urlImage)
                { this._element.style.backgroundImage = "url('"+this._Board._defaultPaths.images+urlImage+"')"; return this; }
                Thing.setBackgroundImageInAlpha = function(urlImage) { return this._setBackgroundImageInAlpha(urlImage); };
                Thing._setBackgroundImageInAlpha = function(urlImage)
                { this._setBackgroundImage(urlImage); this._setBackgroundAplpha(); return this; }
