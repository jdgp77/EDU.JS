...
boardColoniaHormigas.createAnimation(function(info){
    ...
    if(this.my.numHormigas<this.my.maxNumHormigas)
    {
        if(info.timeInSeconds%this.my.addNumHormigasIn_seconds==0 || info.numFrame==1)
        {
            ...
            this.t(nombreHormiga).setImageUrl('http://developer.myrtools.dev/einteractiva/create-complement/colonia-hormigas/images/hormiga.png').setBackgroundColor('transparent');
            this.my.numHormigas++;
        }
    }
